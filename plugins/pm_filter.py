...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="🤔𝙃𝙤𝙬 𝙏𝙤 𝘿𝙤𝙬𝙣𝙡𝙤𝙖𝙙❓", url='https://t.me/SixFlix/269')
        ]
    )
...
async def advantage_spoll_choker(bot, query):
    ...
    if int(user) != 0 and query.from_user.id != int(user):
        return await query.answer("🫠 𝘗𝘭𝘦𝘢𝘴𝘦 𝘚𝘦𝘢𝘳𝘤𝘩🔎 𝘠𝘰𝘶𝘳𝘴𝘦𝘭𝘧\n<i>താഴെ ടൈപ്പ് ചെയ്യ്തു ചോദിക്കു  ..കുഞ്ഞെ...!😁</i>", show_alert=True)
